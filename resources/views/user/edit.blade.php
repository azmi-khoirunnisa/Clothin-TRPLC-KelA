                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ $user->tempat_lahir }}" required autocomplete="tempat_lahir" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_lahir" type="date"  class="form-control datepicker @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" value="{{ $user->tanggal_lahir}}" required autocomplete="tanggal_lahir" autofocus>
